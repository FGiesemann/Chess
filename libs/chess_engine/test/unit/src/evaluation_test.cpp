...
TEST_CASE("Engine.Evaluation.White mated", "[evaluation]") {
...
TEST_CASE("Engine.Evaluation.Black mated", "[evaluation]") {
    const Evaluator evaluator{};
...
TEST_CASE("Engine.Evaluation.Material.Piece Values", "[evaluation]") {
...
TEST_CASE("Engine.Evaluation.Material.Position", "[evaluation]") {
...
TEST_CASE("Engine.Evaluation.Pieces on Squares", "[evaluation]") {
