...
TEST_CASE("Core.Position.Perft.Kiwipete", "[Position][Perft]") {
...
TEST_CASE("Core.Position.Perft.Position 3", "[Position][Perft]") {
...
TEST_CASE("Core.Position.Perft.Position 5", "[Position][Perft]") {
...
TEST_CASE("Core.Position.Perft.Promotions", "[Position][Perft]") {
