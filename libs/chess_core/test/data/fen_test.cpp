...
TEST_CASE("Core.Data.FEN.Read.Empty FEN string", "[FENString][Init]") {
...
TEST_CASE("Core.Data.FEN.Read.Starting position FEN string", "[FENString][Init]") {
...
TEST_CASE("Core.Data.FEN.Read.Piece placement", "[FENString][Validity]") {
...
TEST_CASE("Core.Data.FEN.Read.Side to move", "[FENString][Validity]") {
...
TEST_CASE("Core.Data.FEN.Read.Castling availability", "[FENString][Validity]") {
...
TEST_CASE("Core.Data.FEN.Read.En passant square", "[FENString][Validity]") {
...
TEST_CASE("Core.Data.FEN.Read.Halfmove clock", "[FENString][Validity]") {
...
TEST_CASE("Core.Data.FEN.Read.Full move number", "[FENString][Validity]") {
...
TEST_CASE("Core.Data.FEN.Read.Valid FEN strings", "[FENString][Validity]") {
    // 1. e4
    FenString fen;
...
TEST_CASE("Core.Data.FEN.Write.Piece Placement", "[FENString][Write]") {
...
TEST_CASE("Core.Data.FEN.Write.Castling Availability", "[FENString][Write]") {
...
TEST_CASE("Core.Data.FEN.Write.Whole FEN", "[FENString][Write]") {
...
TEST_CASE("Core.Data.FEN.Write.Position", "[FENString][Write]") {
    std::string fen = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1";
