...
TEST_CASE("Game.SAN.Parser.Castling", "[san]") {
...
TEST_CASE("Game.SAN.Parser.Pieces", "[san]") {
...
TEST_CASE("Game.SAN.Parser.Captures", "[san]") {
...
TEST_CASE("Game.SAN.Parser.Disambiguation", "[san]") {
...
TEST_CASE("Game.SAN.Parser.Check", "[san]") {
...
TEST_CASE("Game.SAN.Parser.Pawn Promotion", "[san]") {
...
TEST_CASE("Game.SAN.Parser.Suffix Annotations", "[san]") {
...
TEST_CASE("Game.SAN.Parser.Mixed Examples", "[san]") {
...
TEST_CASE("Game.SAN.Parser.Invalid SAN", "[san]") {
